...
class Ui_VoGISProfilToolMain(object):
    def setupUi(self, VoGISProfilToolMain):
        ...
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.IDC_rbEquiDistance)
    ...
    def retranslateUi(self, VoGISProfilToolMain):
        VoGISProfilToolMain.setWindowTitle(QtGui.QApplication.translate("VoGISProfilToolMain", "VoGISProfilToolMain", None, QtGui.QApplication.UnicodeUTF8))
